...
namespace sepgraph
{
	...
	void Bitmap2QueueRange(TBitmap &bitmap,
        ...
        // void RebuildArrayCacheIndex(TAppInst &app_inst,
        //                                 PMAGraph &vcsr_graph,
        //                           TGraphDatum &graph_datum,
        //                           const groute::Stream &stream,
		// 		  index_t seg_snode,
        ...
        template<typename TAppInst, typename TGraphDatum>
        void RebuildWorklist_AllVertices(TAppInst &app_inst,
                                  TGraphDatum &graph_datum,
                                  const groute::Stream &stream,
				  index_t seg_snode,
				  index_t seg_nnodes,
				  index_t seg_idx)
        {
            ...
            kernel::RebuildWorklistAllVertices
                    ...
                    graph_datum.GetWorkSourceRangeDeviceObject(seg_snode,seg_nnodes),
                    graph_datum.m_wl_array_in_seg[seg_idx].DeviceObject(),
                    graph_datum.GetBufferDeviceObject(),graph_datum.GetValueDeviceObject()
		    );
      ...
      template<typename TAppInst, typename PMAGraph,typename TGraphDatum>
        void evct_v2(TAppInst &app_inst,
                                    PMAGraph &vcsr_graph,
                                  TGraphDatum &graph_datum,
                                  const groute::Stream &stream,
                  index_t seg_snode,
      ...
      template<typename TAppInst, typename PMAGraph,typename TGraphDatum>
        void RebuildArrayWorklist_identify(TAppInst &app_inst,
                                    PMAGraph &vcsr_graph,
                                  TGraphDatum &graph_datum,
                                  const groute::Stream &stream,
                  index_t seg_snode,
        ...
        template<typename TAppInst, typename PMAGraph,typename TGraphDatum>
        void RebuildArrayWorklist_reset_delta(TAppInst &app_inst,
                                    PMAGraph &vcsr_graph,
                                  TGraphDatum &graph_datum,
                                  const groute::Stream &stream,
				  index_t seg_snode,
	...
	template<typename TAppInst,
                typename PMAGraph,
                // typename WeightDynaT,
                typename TGraphDatum>
        void RunSyncCom(TAppInst &app_inst,
                index_t seg_snode,
                index_t seg_enode,
                uint64_t seg_sedge_csr,
		        index_t seg_idx,
        ...
        {       
            ...
            {
                case LoadBalancing::NONE:
                    kernel::SyncPushDDBFlush<LoadBalancing::NONE>
                            ...
                            graph_datum.cache_edges_l2,
                            graph_datum.cache_edges_com,
                            graph_datum.GetSizeDeviceObject(),
                            graph_datum.GetValueDeviceObject(),
	...
	template<typename TAppInst,
                typename PMAGraph,
                typename TGraphDatum>
        void RunSyncPushDDBAmend_cache(TAppInst &app_inst,
                index_t seg_snode,
                index_t seg_enode,
                uint64_t seg_sedge_csr,
		        index_t seg_idx,
        ...
        {       
            ...
            {
                case LoadBalancing::NONE:
                    kernel::SyncPushDDBAmend_cache<LoadBalancing::NONE>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                        graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                        work_size),
                    ...
                    break;
                case LoadBalancing::COARSE_GRAINED:
                    kernel::SyncPushDDBAmend_cache<LoadBalancing::COARSE_GRAINED>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
                ...
                case LoadBalancing::FINE_GRAINED:
                // LOG("INFO BUG 5\n");
                    kernel::SyncPushDDBAmend_cache<LoadBalancing::FINE_GRAINED>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
                    ...
                    break;
                case LoadBalancing::HYBRID:
                    kernel::SyncPushDDBAmend_cache<LoadBalancing::HYBRID>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
	...
	template<typename TAppInst,
        ...
        {       
            ...
            {
                case LoadBalancing::NONE:
                    kernel::RunSyncPushDDB_MFC<LoadBalancing::NONE>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                        graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                        work_size),
                    ...
                    break;
                case LoadBalancing::COARSE_GRAINED:
                    kernel::RunSyncPushDDB_MFC<LoadBalancing::COARSE_GRAINED>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
                    ...
                    break;
                case LoadBalancing::FINE_GRAINED:
                    kernel::RunSyncPushDDB_MFC<LoadBalancing::FINE_GRAINED>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
                    ...
                    break;
                case LoadBalancing::HYBRID:
                    kernel::RunSyncPushDDB_MFC<LoadBalancing::HYBRID>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
	...
	template<typename TAppInst,
                typename PMAGraph,
                typename TGraphDatum>
        void RunSyncPushDDBAmend(TAppInst &app_inst,
                index_t seg_snode,
                index_t seg_enode,
                uint64_t seg_sedge_csr,
		        index_t seg_idx,
                bool zcflag,
                            const PMAGraph &vcsr_graph, int *type_device,
                            TGraphDatum &graph_datum,
                            EngineOptions &engine_options,
                            const groute::Stream &stream)
        {       
            ...
            {
                case LoadBalancing::NONE:
                    kernel::SyncPushDDBAmend<LoadBalancing::NONE>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                        graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                        work_size),
                    ...
                    break;
                case LoadBalancing::COARSE_GRAINED:
                    kernel::SyncPushDDBAmend<LoadBalancing::COARSE_GRAINED>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
                ...
                case LoadBalancing::FINE_GRAINED:
                // LOG("INFO BUG 5\n");
                    kernel::SyncPushDDBAmend<LoadBalancing::FINE_GRAINED>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
                    ...
                    break;
                case LoadBalancing::HYBRID:
                    kernel::SyncPushDDBAmend<LoadBalancing::HYBRID>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
	...
	template<typename TAppInst,
                typename PMAGraph,
                typename TGraphDatum>
        void RunSyncPushDDBCache(TAppInst &app_inst,
                index_t seg_snode,
                index_t seg_enode,
                uint64_t seg_sedge_csr,
		        index_t seg_idx,
        ...
        {       
            ...
            {
                case LoadBalancing::NONE:
                    kernel::SyncPushDDBCache<LoadBalancing::NONE>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                        graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                        work_size),
                    ...
                    break;
                case LoadBalancing::COARSE_GRAINED:
                    kernel::SyncPushDDBCache<LoadBalancing::COARSE_GRAINED>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
                ...
                case LoadBalancing::FINE_GRAINED:
                // LOG("INFO BUG 5\n");
                    kernel::SyncPushDDBCache<LoadBalancing::FINE_GRAINED>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
                    ...
                    break;
                case LoadBalancing::HYBRID:
                    kernel::SyncPushDDBCache<LoadBalancing::HYBRID>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
 	...
 	template<typename TAppInst,
                ...
                // typename WeightDynaT,
                typename TGraphDatum>
        void RunSyncPushDDB_ALL(TAppInst &app_inst,
                index_t seg_snode,
                index_t seg_enode,
                uint64_t seg_sedge_csr,
		        index_t seg_idx,
        ...
        {       
            ...
            {
                case LoadBalancing::NONE:
                    kernel::SyncPushDDBAll<LoadBalancing::NONE>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                        graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                        work_size),
	...
	template<typename TAppInst,
                ...
                // typename WeightDynaT,
                typename TGraphDatum>
        void RunSyncPushDDB_Delta(TAppInst &app_inst,
                index_t seg_snode,
                index_t seg_enode,
                uint64_t seg_sedge_csr,
                index_t seg_idx,
        ...
        {       
            ...
            {
                case LoadBalancing::NONE:
                    kernel::SyncPushDDBDelta<LoadBalancing::NONE>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                        graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                        work_size),
            ...
            switch (engine_options.GetLoadBalancing(common::MsgPassing::PUSH))
            {
                case LoadBalancing::NONE:
                    kernel::SyncPushDDB<LoadBalancing::NONE>
                            ...
                            graph_datum.cache_edges_l1,
                            graph_datum.cache_edges_l2,
                            graph_datum.nodes_control,
                            graph_datum.GetParentDeviceObject(),
                            graph_datum.GetValueDeviceObject(),
                            graph_datum.GetBufferDeviceObject(),
                        //     graph_datum.GetLevelDeviceObject(),
                            // graph_datum.GetEdgeWeightDeviceObject(),
                            graph_datum.m_wl_bitmap_out_high.DeviceObject(),
                            graph_datum.m_wl_bitmap_in.DeviceObject());
                    break;
...
/**
 * @brief Quaful push_update_tree()
 * @tparam TAppInst  Type of the application
 * @tparam TLoader  Type of graph
 * @tparam TPMAGraph  Type of graph
 * @tparam TWEdgePair  Type of device graph associate data
...
//                 typename TGraphDatum>
	template<typename TAppInst,
                typename PMAGraph,
                typename TGraphDatum>
        void RunSyncPushDDB_ADD(TAppInst &app_inst,
                index_t seg_snode,
                index_t seg_enode,
                uint64_t seg_sedge_csr,
                index_t seg_idx,
        ...
        //     if(zcflag)
            ...
            {
                case LoadBalancing::NONE:
                    kernel::SyncPushDDB_add<LoadBalancing::NONE>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                        graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                        work_size),
                    ...
                    break;
                case LoadBalancing::COARSE_GRAINED:
                    kernel::SyncPushDDB_add<LoadBalancing::COARSE_GRAINED>
                            << < grid_dims, block_dims, 0, stream.cuda_stream >> > (app_inst,seg_snode,seg_enode,seg_sedge_csr,zcflag,
                                 groute::dev::WorkSourceArray<index_t>(
                                         graph_datum.m_wl_array_in_seg[seg_idx].GetDeviceDataPtr(),
                                         work_size),
