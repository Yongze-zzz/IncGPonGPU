...
namespace sepgraph
{
    namespace kernel
    {
        namespace sync_push_td
        {
            ...
            //     uint32_t nthreads = TOTAL_THREADS_1D;
            //     uint32_t work_size =work_source.get_size();
            //     PushFunctorDB<TAppInst, CSRGraph, GraphDatum, TValue, TBuffer, TWeight>
            //             push_functor(app_inst, csr_graph, node_parent,node_buffer_datum, edge_weight_datum,out_active);
